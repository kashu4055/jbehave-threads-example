...
public class ThreadsSteps {
    ...
    @When("<name> counts to <number> of Mississippis")
    public void whenSomeoneCountsToNMississippis(@Named("name") String name, @Named("number") AtomicInteger number) {
        long start = System.currentTimeMillis();
        System.out.println(name + " starts counting to " + number);
